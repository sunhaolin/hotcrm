...
| Timesheet | Controlled by Parent (Delivery Project) | Hours are booked against the project they cost |
...
For the fourteen parent-derived objects above, there is nothing to configure per user: access is *computed*.
