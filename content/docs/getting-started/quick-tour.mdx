...
| **Projects** | Presales Projects, Delivery Projects, Cost Plans, Timesheets, Travel Costs, Business Trips, Leave Requests, Budget Adjustments, Project Cost |
| **Project Finance** | Contracts, Invoices, Collections, Purchase Contracts, Sales Orders, Project Finance |
| **Master Data** | Rate Cards, Travel Standards, Contracting Entities |
