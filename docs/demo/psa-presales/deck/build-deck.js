...
}
{
  ...
  s.addNotes('两张截图就是现场会看到的提示。左边：新建工时表选试点项目，系统写明「实际 264,000 大于等于基线 200,000，工时填报已限制」。右边：差旅成本关联一张草稿出差单，系统提示「尚未审批通过，不能登记差旅成本」。两条提示都是保存那一刻由系统给出的，换一个健康项目或已审批的出差单即可保存。');
}
