 ...
 * and the sales contract it is collected under, optionally matched to an
 * invoice. Entered by hand this round.
 */
export const Collection = ObjectSchema.create({
  ...
  highlightFields: ['crm_delivery_project', 'crm_contract', 'crm_invoice', 'received_date', 'amount'],
  fieldGroups: [
