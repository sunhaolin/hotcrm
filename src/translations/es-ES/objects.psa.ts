...
export const psa: Record<string, Partial<ObjectTranslationData>> = {
  ...
  crm_cost_plan: {
    ...
    fields: {
      ...
      planned_month_total: { label: 'Total planificado del desglose mensual' },
      labor_month_total: { label: 'Total de servicio de personal del desglose mensual' },
      service_month_total: { label: 'Total de servicios de terceros del desglose mensual' },
      procurement_month_total: { label: 'Total de compra de hardware/software del desglose mensual' },
      expense_month_total: { label: 'Total de gastos del proyecto del desglose mensual' },
      travel_month_total: { label: 'Viajes incluidos del desglose mensual' },
      labor_line_total: { label: 'Total estimado de servicio de personal' },
      service_line_total: { label: 'Total estimado de servicios de terceros' },
      procurement_line_total: { label: 'Total estimado de compra de hardware/software' },
      expense_line_total: { label: 'Total estimado de gastos del proyecto' },
      travel_line_total: { label: 'Viajes incluidos estimados' },
      planned_total: { label: 'Total planificado', help: 'Suma de las cuatro estimaciones de línea en un Bizcase; suma del desglose mensual en un plan de entrega.' },
  ...
  crm_labor_cost_line: {
    ...
    fields: {
      ...
      estimate_amount: { label: 'Importe estimado' },
      allocated_amount: { label: 'Importe desglosado' },
