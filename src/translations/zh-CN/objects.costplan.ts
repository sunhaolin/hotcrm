...
const lineBase = {
  ...
  planned_amount: { label: '计划金额', help: 'Bizcase 明细行为按系数算出的整段估算；交付明细行为本行各月度分解行金额之和。不能手填。' },
  estimate_amount: { label: '估算金额' },
  allocated_amount: { label: '已分解金额' },
  notes: { label: '备注' },
};
const redecompose = {
...
export const costplan: Record<string, Partial<ObjectTranslationData>> = {
  ...
  crm_cost_plan: {
    ...
    fields: {
      ...
      phase: { label: '阶段', help: '保存时按所挂项目自动写入。Bizcase（售前）阶段的明细行不按月拆分、不生成月度分解行，金额直接算在明细行上；交付阶段按月分解。', options: { bizcase: 'Bizcase（售前）', delivery: '交付' } },
      ...
      planned_month_total: { label: '月度分解计划总额' },
      labor_month_total: { label: '月度分解人工服务合计' },
      service_month_total: { label: '月度分解第三方服务合计' },
      procurement_month_total: { label: '月度分解软硬件采购合计' },
      expense_month_total: { label: '月度分解项目费用合计' },
      travel_month_total: { label: '月度分解其中差旅' },
      labor_line_total: { label: '估算人工服务合计' },
      service_line_total: { label: '估算第三方服务合计' },
      procurement_line_total: { label: '估算软硬件采购合计' },
      expense_line_total: { label: '估算项目费用合计' },
      travel_line_total: { label: '估算其中差旅' },
      planned_total: { label: '计划总额', help: 'Bizcase 为四类明细行估算之和；交付计划为月度分解行之和。' },
