...
import { psa } from './es-ES/objects.psa';
...
export const esES: TranslationData = {
  objects: {
    ...
    crm_cost_plan: psa.crm_cost_plan,
    crm_labor_cost_line: psa.crm_labor_cost_line,
    crm_service_cost_line: psa.crm_service_cost_line,
    crm_procurement_cost_line: psa.crm_procurement_cost_line,
    crm_expense_cost_line: psa.crm_expense_cost_line,
    crm_cost_plan_month: psa.crm_cost_plan_month,
    crm_timesheet: psa.crm_timesheet,
    crm_travel_cost: psa.crm_travel_cost,
    crm_rate_card: psa.crm_rate_card,
    crm_travel_standard: psa.crm_travel_standard,
