...
export const psa: Record<string, Partial<ObjectTranslationData>> = {
  ...
  crm_cost_plan: {
    ...
    fields: {
      ...
      planned_month_total: { label: '月次分解の計画総額' },
      labor_month_total: { label: '月次分解の人的サービス合計' },
      service_month_total: { label: '月次分解の第三者サービス合計' },
      procurement_month_total: { label: '月次分解のハード・ソフト購買合計' },
      expense_month_total: { label: '月次分解のプロジェクト経費合計' },
      travel_month_total: { label: '月次分解のうち出張' },
      labor_line_total: { label: '見積の人的サービス合計' },
      service_line_total: { label: '見積の第三者サービス合計' },
      procurement_line_total: { label: '見積のハード・ソフト購買合計' },
      expense_line_total: { label: '見積のプロジェクト経費合計' },
      travel_line_total: { label: '見積のうち出張' },
      planned_total: { label: '計画総額', help: 'Bizcase では 4 種の明細見積の合計、デリバリー計画では月次分解の合計です。' },
  ...
  crm_labor_cost_line: {
    ...
    fields: {
      ...
      estimate_amount: { label: '見積金額' },
      allocated_amount: { label: '分解済み金額' },
